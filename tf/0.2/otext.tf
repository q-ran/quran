...
@fmt:lex-trans-full={lemma}{space}
@fmt:root-trans-full={root}{space}
@fmt:text-orig-full={unicode}{space}
@fmt:text-trans-full={ascii}{space}
...
@dateWritten=2019-01-07T18:59:25Z
